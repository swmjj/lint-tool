...
module.exports = {
  extends: ['ali'],
  rules: {
    'type-enum': [1, 'always', ['feat', 'fix', 'docs', 'style', 'refactor', 'test', 'revert','perf','build','ci','chore','init']]
  },
  prompt: {
...
':recycle:' },
      ...
      { value: 'init', name: 'init: 初始化项目 init project', emoji: ':rewind:' },
    ],
    useEmoji: false,
    emojiAlign: 'center',
    themeColorCode: '',
    ...
    breaklineNumber: 100,
    breaklineChar: '|',
    skipQuestions: ['scope', 'breaking', 'footerPrefix' ],
